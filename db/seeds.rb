...
## Snowden
picture = File.open('../data/Snowden/SnowdenImage.webp')
...
m8.picture.attach(io: picture, filename: 'TheDarkKnightImage.webp')
...
## The Departed
picture = File.open('../data/TheDeparted/TheDepartedImage.webp')
